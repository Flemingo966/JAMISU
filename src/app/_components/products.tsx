...
const Products = () => {
  const data = [
    { text: " ERP One", icon: ERPIcon, link: "#" },
    { text: " Hour Flux", icon: TimestampIcon, link: "#" },
    { text: " Vendor WMS", icon: WarehouseIcon, link: "#" },
    { text: " Warehouse Management", icon: RentalIcon, link: "#" },
